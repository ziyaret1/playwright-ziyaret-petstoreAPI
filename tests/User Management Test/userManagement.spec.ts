...
test.describe("Login User Suite", () => {
  test("[TRA-003] Log in with valid credentials", async ({
    userApi,
    userHelpers,
  }) => {
  ...
  test("[TRA-004] Log in with invalid credentials", async ({
    userApi,
    userHelpers,
  }) => {
...
test.describe("Get User Suite", () => {
  ...
  test("[TRA-007] Get user with invalid username format", async ({
    userApi,
  }) => {
...
test.describe("Update User Suite", () => {
  test("[TRA-008] Update existing user successfully", async ({ userApi }) => {
    ...
    const getUpdatedResponse = await userApi.getUserWithUsername(
      UpdatedUserData.username
    );
...
test.describe("Delete User Suite", () => {
  ...
  test("[TRA-013] Delete user with invalid username format", async ({
    userApi,
  }) => {
